...
from training.utils.callbacks import SavePeftModelCallback
from training.utils.schedulers import InterpolatingLogScheduler
...
def setup_trainer(cfg, train_dataset, eval_dataset, model, tokenizer):
    ...
    if cfg.is_llama_derived_model and cfg.landmark_attention:
        ...
        from training.monkeypatch.llama_landmark_attn import MEM_TOKEN, add_mem_tokens
