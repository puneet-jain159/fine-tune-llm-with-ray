...
from training.prompt_tokenizers import LLAMA_DEFAULT_PAD_TOKEN

if TYPE_CHECKING:
    from peft import PeftConfig  # noqa: F401

    from training.utils.dict import DictDefault  # noqa: F401
...
def load_model(
    ...
    if cfg.is_llama_derived_model and cfg.flash_attention:
        if cfg.device not in ["mps", "cpu"] and inference is False:
            from training.flash_attn import replace_llama_attn_with_flash_attn

            logging.info("patching with flash attention")
            replace_llama_attn_with_flash_attn()
    elif cfg.is_llama_derived_model and cfg.xformers_attention:
        from training.monkeypatch.llama_attn_hijack_xformers import (
        ...
        from training.monkeypatch.llama_landmark_attn import (  # pylint: disable=redefined-outer-name # noqa: F811
            MEM_TOKEN,
            LlamaForCausalLM,
        )
